...
3. [Getting JIRA API key](#getting-jira-api-key)
4. [Remarks](#remarks)
...
For JIRA Cloud, use an Atlassian API token as the `JIRA_API_KEY`.

You can create or manage your API tokens here:

https://id.atlassian.com/manage-profile/security/api-tokens

Create a new API token, copy it, and use it as the `JIRA_API_KEY` in the JIRA settings.
